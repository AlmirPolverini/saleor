...
def test_add_public_metadata_for_customer_as_staff(
    ...
    # given
    assert not customer_user.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_other_staff_as_staff(
    ...
    # given
    assert not admin_user.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_myself_as_customer(user_api_client):
    ...
    assert not customer.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_myself_as_staff(staff_api_client):
    ...
    assert not staff.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_order(api_client, order):
    # given
    assert not order.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_attribute(
    ...
    # given
    assert not color_attribute.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_category(
    ...
    # given
    assert not category.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_collection(
    ...
    # given
    assert not collection.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_digital_content(
    ...
    # given
    assert not digital_content.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_fulfillment(
    ...
    # given
    assert not fulfillment.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_product(
    ...
    # given
    assert not product.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_product_type(
    ...
    # given
    assert not product_type.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
...
def test_add_public_metadata_for_service_account(
    ...
    # given
    assert not service_account.get_meta(PUBLIC_META_NAMESPACE, META_CLIENT)
